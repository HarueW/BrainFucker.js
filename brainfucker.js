...
function _step (t, r, s) {
  ...
  switch ((e = n[s++])) {
    ...
    case '[':
      if (((typeof (i = c.top()) === 'number' && i === s - 1) || c.push(s - 1), !a)) for (var h, p = 1, _ = { '[': 1, ']': -1 }; !_[(h = n[s++])] || (p += _[h]););
      break
    case ']':
      typeof (i = c.top()) !== 'number' ? (this._error = new Error('No preceeding "]"')) : a ? (s = i) : c.pop()
      break
    default:
...
function exec (t, r) {
  ...
  (this._callback = typeof r === 'function' ? r.bind(this) : void 0),
  (this._stack = []),
